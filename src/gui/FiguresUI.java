...
public class FiguresUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Координаты углов:");
    ...
    private void projectorFileBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_projectorFileBtnActionPerformed
        ...
        if (isByHands) {
            ...
            try {
                ...
                Renderer.xProjectorCoord = parse.getCOORDS()[0];
                Renderer.yProjectorCoord = parse.getCOORDS()[1];
                Renderer.zProjectorCoord = parse.getCOORDS()[2];
